...
!function () {
  "use strict";
  function e(n) {
    return "undefined" == typeof this || Object.getPrototypeOf(this) !== e.prototype ? new e(n) : (O = this, O.version = "3.3.1", O.tools = new E(), O.isSupported() ? (O.tools.extend(O.defaults, n || {}), t(O.defaults), O.store = { elements: {}, containers: [] }, O.sequences = {}, O.history = [], O.uid = 0, O.initialized = !1) : "undefined" != typeof console && null !== console, O);
  }function t(e) {
    if (e && e.container) {
    ...
    function t() {
      ...
      return "fixed" === window.getComputedStyle(e.domEl).position;
        ...
        d = c + a,
        u = f + l;return t() || n();
  }function E() {}var O, T;e.prototype.defaults = { origin: "bottom", distance: "20px", duration: 500, delay: 0, rotate: { x: 0, y: 0, z: 0 }, opacity: 0, scale: .9, easing: "cubic-bezier(0.6, 0.2, 0.1, 1)", container: window.document.documentElement, mobile: !0, reset: !1, useDelay: "always", viewFactor: .2, viewOffset: { top: 0, right: 0, bottom: 0, left: 0 }, beforeReveal: function beforeReveal(e) {}, afterReveal: function afterReveal(e) {}, beforeReset: function beforeReset(e) {}, afterReset: function afterReset(e) {} }, e.prototype.isSupported = function () {
